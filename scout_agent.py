...
def get_publisher_fleet_health(
    ...
    Rolling 4-week same-period average as baseline (not sequential-window median).
    Only surfaces publishers with >= $500/week baseline AND >= 1.5σ below normal.

    Classifies:
    - Act Now: >= 2σ below normal AND >= $500 dollar gap
    - Watch:   >= 1.5σ below normal AND >= $200 dollar gap
    - Healthy: on or above baseline (top 5 by dollar gain shown)
