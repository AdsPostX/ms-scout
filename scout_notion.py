...
# narrower routing table that silently drifts (was: "offers" only, every other
# purpose fell through to _SCOUT_HQ_CHANNEL even in production). Import is
# deferred to call time — scout_bot imports this module at load time, so a
