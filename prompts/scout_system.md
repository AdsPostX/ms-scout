...
ClickHouse does NOT contain the following. Do not query for these, do not loop trying to find them:
...
Rules:
- SECTION BREAKS: \n---\n exactly, no blank lines, no spaces around dashes. Scout Kit auto-converts this into a Block Kit divider before sending.
